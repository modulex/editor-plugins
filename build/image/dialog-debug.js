define('kg/editor-plugins/1.2.0/image/dialog',["util","editor","io","../dialog","tabs","../menubutton","./dialog-tpl","ua","node"],function(require, exports, module) {
 /**
 * @ignore
...
(ImageDialog.prototype = {
  _prepare: function () {
    ...
    self.imgBorderWidth = content.one('.' + prefixCls + 'img-border-width');
...
//                    }
  ...
  _insert: function () {
    var self = this,
      ...
      borderWidth = parseInt(valInput(self.imgBorderWidth), 10),
  ...
  _update: function (selectedEl) {
    ...
    if (selectedEl && self.imageCfg.remote !== false) {
      ...
      var borderWidth= parseInt(selectedEl.style('border-width'), 10) || 0;
      self.imgBorderWidth.val(borderWidth);
      if (h) {

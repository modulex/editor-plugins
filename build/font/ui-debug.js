define('kg/editor-plugins/1.2.0/font/ui',["editor","../button","../menubutton"],function(require, exports, module) {
 /**
 * @ignore
    ...
    editor.on('selectionChange', function () {
      ...
      if (children) {
        ...
        if (currentValue !== false) {
          currentValue = quoteNormalize((currentValue + '').toLowerCase());
          for (var j = 0; j < children.length; j++) {
            var item = children[j];
            var value = item.get('value');
            if (currentValue === quoteNormalize(value.toLowerCase())) {
